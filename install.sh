...
echo -e "  ${BLUE}→${NC} ${HOOK_COUNT} ${MSG_HOOKS}       (.claude/hooks/)"
...
echo -e "  ${YELLOW}/spec-fix${NC}     → Bug fix tracking (after implement)"
echo -e "  ${YELLOW}/spec-close${NC}   → Feature closure (after review)"
echo ""
